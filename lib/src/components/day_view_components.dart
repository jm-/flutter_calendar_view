    ...
    return ConstrainedBox(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) => InkWell(
          onLongPress: onEventLongPress != null ? () => onEventLongPress!(events, date) : null,
          onTap: onEventTap != null ? () => onEventTap!(events, date) : null,
          onDoubleTap: onEventDoubleTap != null ? () => onEventDoubleTap!(events, date) : null,
